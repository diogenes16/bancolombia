...
Inténtalo de nuevo, datos erróneos.
    ...
    <div class="select-container">
      ...
      <select id="tipoDocumento" class="select-custom">
        <option value="" disabled selected>Tipo de documento</option>
        <option value="cedula">Cédula de Ciudadanía</option>
        <option value="tarjeta">Tarjeta de Identidad</option>
      </select>
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down arrow-icon" viewBox="0 0 16 16">
    ...
    <input type="tel" id="txtUsuario" name="txtUsuario" maxlength="10" class="gotens-kame-us" placeholder=" ">
...
<div class="text-center mt-3">
  <button id="btnUsuario" name="btnUsuario" class="ban-boom" disabled>CONTINUAR</button>
</div>
